...
Сверено **218** функций из **218** (по `PORTING.md`).
...
| `data/chr.bmp` | BMP-изображение 128×256 (512 тайлов 8×8), 4-bit indexed (16 цветов, используются 4). Верхние 128×128 — банк спрайтов (тайлы 0–255), нижние 128×128 — банк фона (тайлы 256–511). Значения пикселей 0–3 напрямую маппятся в NES 2bpp биты |
...
├── CMakeLists.txt
├── data/
│   └── chr.bmp              # BMP-тайлы 128×256, 4-bit indexed (альтернатива .bin)
├── src/
